/*Constructor: spl type of method having same name as a class name.
...
-Types of Constructor  : 1.Default constructor.(set default value to state of object[variable in class]).
...
public static void main(String args[])
{
  ...
  Student d1 = new Student(1,"saloni",90.20);
